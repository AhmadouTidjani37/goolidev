...
import tidjaniThumbnail from '../../assets/images/propos-thumbnail.jpg'; 
      ...
      <div className="space-y-20">
          ...
          <div className="lg:w-1/2 animate-slide-right">
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/5] w-full max-w-md mx-auto bg-gray-200">
                {/* Miniature floue (optionnelle) */}
                {tidjaniThumbnail && !imageLoaded && (
                  <div 
                    className="absolute inset-0 bg-cover bg-center filter blur-xl scale-110 transition-opacity duration-1000 z-10"
                    style={{ 
                      backgroundImage: `url(${tidjaniThumbnail})`,
                ...
                {/* Overlay léger pour améliorer la lisibilité des badges */}
                ...
                {imageError && (
                  <div className="absolute inset-0 bg-gradient-to-br from-primary-100 to-secondary-100 flex items-center justify-center z-30">
                    <span className="text-4xl font-bold text-primary-600">AT</span>
                  </div>
                )}
              </div>
              
              {/* Badges d'information - repositionnés pour être toujours visibles */}
              <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 flex flex-wrap gap-2 justify-center w-full px-4 z-30">
                <div className="bg-white rounded-lg shadow-lg px-4 py-2 flex items-center space-x-2 animate-float hover:shadow-xl transition-shadow">
                  <MapPin className="w-4 h-4 text-primary-600" />
                  <span className="text-sm font-medium">Garoua, Cameroun</span>
                </div>
                <div className="bg-white rounded-lg shadow-lg px-4 py-2 flex items-center space-x-2 animate-float hover:shadow-xl transition-shadow" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-100">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                {founderAchievements.map((achievement, index) => (
                  <div key={index} className="flex items-center space-x-2 bg-gray-50 p-2 rounded-lg hover:bg-primary-50 transition-colors">
              ...
              <p className="text-gray-600 italic border-l-4 border-primary-600 pl-4 py-2 mb-6 bg-primary-50/30 rounded-r-lg">
            ...
            {advantages.map((advantage, index) => {
              ...
              return (
                <Card 
                  key={index} 
                  padding="lg" 
                  className="text-center hover:shadow-xl transition-all hover:-translate-y-2 animate-fade-in group"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="flex justify-center mb-4">
                    <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center group-hover:bg-primary-200 group-hover:scale-110 transition-all duration-300">
        ...
        <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-2xl p-8 text-white shadow-xl">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            ...
            <div className="group cursor-default">
              <div className="text-4xl font-bold mb-2 group-hover:scale-110 transition-transform">52+</div>
              <div className="text-white/90">Projets réalisés</div>
            </div>
            <div className="group cursor-default">
              <div className="text-4xl font-bold mb-2 group-hover:scale-110 transition-transform">47+</div>
              <div className="text-white/90">Clients satisfaits</div>
            </div>
            <div className="group cursor-default">
              <div className="text-4xl font-bold mb-2 group-hover:scale-110 transition-transform">12+</div>
